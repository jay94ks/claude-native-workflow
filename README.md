...
- **웹 UI에서 DocType 관리**(`DocTypeManager.vue`) - 프로젝트/프로젝트
  ...
  (프로젝트의 "설정" 탭, 프로젝트 그룹·기관 목록 화면 각 행의 "문서 타입
